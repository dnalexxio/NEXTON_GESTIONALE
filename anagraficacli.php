...
var dsAnagrafica = new Spry.Data.XMLDataSet("file_xml/anagrafica.php?usern=<?php echo $_GET['usern'];?>", "voce");
...
function saveHandler(newValue, oldValue) {
		...
		dojoeditForm('<?php echo $_GET['usern'];?>',this,newValue); //NON FUNZIONA SU IE 
	}
