	...
	<div  id="Special_DIV" spry:region="dsSeek" >
		...
		<table id="products" name="lista" class="rigablu">
			...
			<tr>
				...
				<th scope="col" width="35%"><font ><center>BestPrice</center></font></th>
				<th scope="col" width="1%"><font ><center>ORDINA</center></font></th>
			</tr>
			<tbody spry:repeatchildren="dsSeek">
				<tr  class="even" onclick="dojo.widget.byId('bestp').setUrl('bestpriceshow.php?codpr={code}');dojo.widget.byId('princ').setUrl('newbuy.php?getcode={id}&nomep={name}&cat={category}&p={price}&codpr={code}');;" spry:hover="rowHover" spry:select="rowSelected">
...
<table><TR>
<TD width="20%"><div dojoType="ContentPane" id="princ" ></div></TD>
<td width="10%"><div dojoType="ContentPane" id="docpane"></div></td>
<td width="10%"><div dojoType="ContentPane" id="lateralpane"></div></td>
<td width="10%"><div dojoType="ContentPane" id="bestp"></div></td>
</TR>
</table>
</body>
</html>
