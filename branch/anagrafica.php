...
var dsAnagrafica = new Spry.Data.XMLDataSet("file_xml/anagrafica.php?usern=<? echo $_SESSION['logged'];?>", "voce");
...
function saveHandler(newValue, oldValue) {
		...
		dojoeditForm('<? echo $_SESSION['logged'];?>',this,newValue); //NON FUNZIONA SU IE 
	}
