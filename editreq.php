...
case "settore]":$tabella="utente"; $dove="settore";break;
case "notaperm]":$tabella="utente"; $dove="notapermanente";break;
...
case "categoria]": $tabella="utente"; $dove="categoria"; break;
case "zona]": $tabella="utente"; $dove="zona"; break;
case "ind_pec]": $tabella="utente"; $dove="ind_pec"; break;
case "codice_sdi]": $tabella="utente"; $dove="codice_sdi"; break;
}
if ($dove=="") {
...
if($tabella=="utente") {
							if ($dove=="password"){
													$sql ="UPDATE $tabella SET $dove = md5('{$_REQUEST['cosa']}') where utente='{$_REQUEST['chi']}'"; //nell'orig era id!
													}
							else $sql ="UPDATE $tabella SET $dove = '{$_REQUEST['cosa']}' where utente='{$_REQUEST['chi']}'"; //nell'orig era id!
							}
