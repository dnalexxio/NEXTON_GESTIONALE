...
<input type="text" name="art">  AZIENDA:<input type="text" name="cat"> codice cliente:<?php echo $_SESSION['loggedid'];?>
<input type="button" value="ricerca" onclick="drill(art.value,cat.value,<?php echo $_SESSION['loggedid'];?>)">
