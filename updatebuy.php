...
<input type="hidden" name="updateone" value="<?php echo $codice;?>">
<input  type="hidden" name="oldmisura" value="<?php echo $_GET['misur'];?>">
<input  type="hidden" name="updateorderno" value="<?php echo $_SESSION['conto'];?>">
