...
[<a href="index.php" >HOME PAGE</a>] [ <a href="newSeek.php">Ricerca Tradizionale</a>] </div>
	...
	<div id="stile" align="right" >Fabio Giliberti<br>Rappresentanze<br>3396232638<br>fgiliberti@libero.it</div>
        <div align="right"><font size="6px">Ricerca Prodotto</font></div><p><a href="neworders.php" target="new">Visualizza ordine corrente in una nuova finestra</a><?php if(isset($_SESSION['conto'])) echo"   &nbsp;&nbsp;&nbsp;&nbsp;   Hai un ordine aperto, il numero ".$_SESSION['conto'] ?></p>
